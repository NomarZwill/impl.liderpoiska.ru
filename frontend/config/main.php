    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                ['pattern'=>'/specialists/getmicrodata/','route'=>'specialists/getmicrodata', 'suffix'=>'/'],
                ...
                ['pattern'=>'/articles/ajax-get-more-articles','route'=>'articles/ajax-get-more-articles', 'suffix'=>'/'],
                ...
                ['pattern'=>'/nashi-raboty/<workName:[\w-]+>','route'=>'our-works/work-page', 'suffix'=>'/'],
                ['pattern'=>'/nashi-raboty/','route'=>'our-works/index', 'suffix'=>'/'],
            ],
        ],
    ],
    'params' => $params,
