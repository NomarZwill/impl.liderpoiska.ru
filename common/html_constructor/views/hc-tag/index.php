 ...
 * @var common\models\search\HcTag $searchModel
 */
$this->title = Yii::t('models', 'Hc Tags');
...
?>
<div class="giiant-crud hc-tag-index">
					...
					[
						...
						'dropdown' => [
							...
							'items' => [
								...
								[
									'url' => ['/hc-draft/index'],
									'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Hc Draft'),
								],
								[
									'url' => ['/user/index'],
