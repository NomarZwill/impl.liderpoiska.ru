		...
		'attributes' => [
			...
			[
				...
				'value' => ($model->createdBy ?
					...
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'HcDraft' => ['created_by' => $model->created_by]])
					:
			...
			[
				...
				'value' => ($model->updatedBy ?
					...
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'HcDraft' => ['updated_by' => $model->updated_by]])
					:
					'<span class="label label-warning">?</span>'),
			],
		],
